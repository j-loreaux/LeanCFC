...
Because this file so closely mirrors the unital one, comments that would be redundant are omitted.
The main thing present in this file that does *not* appear in the unital version is the instance of
a non-unital continuous functional calculus in unital algebras. This can be found at the end of
this file as the instance `ContinuousFunctionalCalculus.toNonUnital`
